    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <ul class="navbar-nav ml-auto">
		  ...
		  <?php
			...
			<li class="nav-item">
			<a class="nav-link"><form method="post"><button class="btn btn-outline-success my-2 my-sm-0" name="logout" type="submit">
			Log Out
			</button></form></a>
			</li>
			<?php
...
<!-- 				<span style="font-family: 'Miriam Libre', sans-serif; font-size:18px;color:#CB202D;">
		 ...
		 <div class="col-sm-2">₦<span style="color:green; font-size:20px;"> <?php echo $res['cost']; ?></span></div>
		 <form method="post">
